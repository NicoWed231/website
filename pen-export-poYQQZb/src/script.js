...
var i = 0;
var txt1 =
  "Hi Sengku CATHY CANTIK , Happy Anniv yaa!  <<              Pokoknya semoga kita langgeng terus ya ayang. <<<                walaupun i tak bisa physically merayakan valentines bareng tapi i tetep senengggg bisa ngerayain nanti di call atau vc hehe...                                                                           > i wanna tell u smthn seng < menurut aku km adalah manusia, pacar, calon istri aku yang terbaik didunia ini AOWKOWKOK.  <<                  setiap hari kita jalanin ldr makin cinta aku sama km seng kea rasanya gapernah jauh anjay < aku berharap kita selalu langgeng ya sayangkuu walaupun masalah kita cuma jarak tapi hati kita gapernah jauh ANJAYY KELAZZ <<                          btw ini pertama kali aku bikin ginian so maap kalo jelek dimaklumin saja aku sering nyontek pas coding soalnya AOKWOWKOKW                                                     > intinyaa happy valentines buat kita ber2 im sorry tak bisa kasii u kado special ya tapi next yearr aku yakin bisaaa rayain bareng and tuker kado okey...!                     <<gila ya kadang aku gangerti kenapa bisa sayang banget sama km and sampe gabisa hidup sama km seng keanya kita memangf pure jodoh AOWKWOKWOKO                                                    > oke jadi pendek saja seng karna agak repot ya kodingnya WKWKWKW                    << intinya di valentines ini akuuuuuu sukaa banget karna ngerayain and dapet kado nantinya dari kamu AOWKWOKWOWOKOKW                                                             >I LOVE U sengg forever and ever <3 < |                  <<<< ini kado dari nicholas yoel yang ganteng";
var speed = 50;
typeWriter();
function typeWriter() {
  if (i < txt1.length) {
